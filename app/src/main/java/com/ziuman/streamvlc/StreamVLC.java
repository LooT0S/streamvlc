...
public class StreamVLC extends AppCompatActivity {
    ...
    private EditText meditTextUDP = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stream_v_l_c);


        Log.d(LOG_TAG, "Запрашиваем разрешение");
        if (checkSelfPermission(Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED
                ||
                (ContextCompat.checkSelfPermission(StreamVLC.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)
        ) {
            requestPermissions(new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        }

        mButtonOpenCamera1 = findViewById(R.id.button1);
        mButtonSettings = findViewById(R.id.button2);
        mButtonTStopStreamVideo = findViewById(R.id.button3);
        meditTextIP = findViewById(R.id.editTextIP);
        meditTextUDP = findViewById(R.id.editTextUDP);
        ...
        mButtonSettings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ip_address = meditTextIP.getText().toString();
                port = Integer.parseInt(meditTextUDP.getText().toString());

                Toast.makeText(StreamVLC.this, " Configuration changed successfully", Toast.LENGTH_SHORT).show();
        ...
        mButtonTStopStreamVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCodec != null) {
                    ...
                    Toast.makeText(StreamVLC.this, " Stream stopped ", Toast.LENGTH_SHORT).show();
